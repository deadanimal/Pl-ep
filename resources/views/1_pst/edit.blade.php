            ...
            <div class="card-body">
                ...
                user_id --}}
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            <input type="text" class="form-control" name="pst_perihal_taklimat" value="{{$PembelianSebutTender->pst_perihal_taklimat}}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            <input type="date" class="form-control" name="pst_taklimat_date" value="{{$PembelianSebutTender->pst_taklimat_date}}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            <input type="text" class="form-control" name="pst_taklimat_alamat" value="{{$PembelianSebutTender->pst_taklimat_alamat}}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            <input type="text" class="form-control" name="pst_link" value="{{$PembelianSebutTender->pst_link}}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            <select name="pst_pelulus"  class="form-select" disabled>
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            <input type="text" class="form-control" name="pst_kehadiran_max" value="{{$PembelianSebutTender->pst_kehadiran_max}}" readonly>
                        </div>
                    </div>
                ...
                pst_updated_date --}}
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            <input type="text" class="form-control" name="pst_jenis_potongan" value="{{$PembelianSebutTender->pst_jenis_potongan}}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            <input type="text" class="form-control" name="pst_potongan_description" value="{{$PembelianSebutTender->pst_potongan_description}}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            <input type="text" class="form-control" name="pst_amaun_potongan" value="{{$PembelianSebutTender->pst_amaun_potongan}}" readonly>
                        </div>
                    </div>
