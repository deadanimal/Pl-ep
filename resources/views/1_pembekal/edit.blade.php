        ...
        <form method="POST" action="/Pembekal/{{$pembekal->id}}" enctype="multipart/form-data">
            ...
            <fieldset>
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-6">
                        <input type=text style=text-transform:uppercase name=pembekal_company_name class="form-control" value="{{$pembekal->pembekal_company_name}}">
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-6">
                        <input type=text style=text-transform:uppercase name=pembekal_jenis_company class="form-control" value="{{$pembekal->pembekal_jenis_company}}">
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-6">
                        <input type=text style=text-transform:uppercase name=pembekal_no_pendaftaran class="form-control" value="{{$pembekal->pembekal_no_pendaftaran}}">
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-6">
                        <input type=text style=text-transform:uppercase name=pembekal_income_tax_no class="form-control"
                            style=text-transform:uppercase value="{{$pembekal->pembekal_income_tax_no}}">
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-6">
                        <input type=text style=text-transform:uppercase name=pembekal_company_address
                            class="form-control" value="{{$pembekal->pembekal_company_address}}">
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-6">
                        <input type=text style=text-transform:uppercase name=pembekal_city class="form-control" value="{{$pembekal->pembekal_city}}">
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-6">
                        <input type="text" name="pembekal_state" class="form-control" value="{{$pembekal->pembekal_state}}">
...
<br><br>
    ...
    <fieldset>
        ...
        <div class="row">
            ...
            <div class="mb-3 col-md-6">
                <input type=text style=text-transform:uppercase name=pembekal_pemilik class="form-control" value="{{$pembekal->pembekal_pemilik}}">
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="mb-3 col-md-6">
                <input type=text style=text-transform:uppercase name=pembekal_citizenship class="form-control" value="{{$pembekal->pembekal_citizenship}}">
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="mb-3 col-md-6">
                <input type=text style=text-transform:uppercase name=pembekal_identity_no class="form-control"  value="{{$pembekal->pembekal_identity_no}}">
            </div>
        </div>
...
<br><br>
    ...
    <fieldset>
        ...
        <div class="row">
            ...
            <div class="mb-3 col-md-6">
                <input type=text name=pembekal_cbp_no class="form-control" style=text-transform:uppercase value="{{$pembekal->pembekal_cbp_no}}">
            </div>
        </div>
