				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item active">
						...
						<ul id="forms" class="sidebar-dropdown list-unstyled collapse show" data-bs-parent="#sidebar">
							...
							<li class="sidebar-item active"><a class="sidebar-link" href="forms-wizard.html">Wizard</a></li>
						</ul>
					</li>
					<li class="sidebar-item">
					...
					<div class="row">
						<div class="col-12 col-xxl-6">
							<div id="smartwizard-default-primary" class="wizard wizard-primary mb-4">
								<ul class="nav">
									<li class="nav-item"><a class="nav-link" href="#default-primary-step-1">First Step<br /><small>Step description</small></a>
									</li>
									<li class="nav-item"><a class="nav-link" href="#default-primary-step-2">Second Step<br /><small>Step description</small></a>
									</li>
									<li class="nav-item"><a class="nav-link" href="#default-primary-step-3">Third Step<br /><small>Step description</small></a>
									</li>
									<li class="nav-item"><a class="nav-link" href="#default-primary-step-4">Fourth Step<br /><small>Step description</small></a>
									</li>
								</ul>
							...
							<div id="smartwizard-default-success" class="wizard wizard-success mb-4">
								<ul class="nav">
									<li class="nav-item"><a class="nav-link" href="#default-success-step-1">First Step<br /><small>Step description</small></a>
									</li>
									<li class="nav-item"><a class="nav-link" href="#default-success-step-2">Second Step<br /><small>Step description</small></a>
									</li>
									<li class="nav-item"><a class="nav-link" href="#default-success-step-3">Third Step<br /><small>Step description</small></a>
									</li>
									<li class="nav-item"><a class="nav-link" href="#default-success-step-4">Fourth Step<br /><small>Step description</small></a>
									</li>
								</ul>
							...
							<div id="smartwizard-default-danger" class="wizard wizard-danger mb-4">
								<ul class="nav">
									<li class="nav-item"><a class="nav-link" href="#default-danger-step-1">First Step<br /><small>Step description</small></a>
									</li>
									<li class="nav-item"><a class="nav-link" href="#default-danger-step-2">Second Step<br /><small>Step description</small></a>
									</li>
									<li class="nav-item"><a class="nav-link" href="#default-danger-step-3">Third Step<br /><small>Step description</small></a>
									</li>
									<li class="nav-item"><a class="nav-link" href="#default-danger-step-4">Fourth Step<br /><small>Step description</small></a>
									</li>
								</ul>

								<div class="tab-content">
									<div id="default-danger-step-1" class="tab-pane" role="tabpanel">
										Step Content 1
									</div>
									<div id="default-danger-step-2" class="tab-pane" role="tabpanel">
										Step Content 2
									</div>
									<div id="default-danger-step-3" class="tab-pane" role="tabpanel">
										Step Content 3
									</div>
									<div id="default-danger-step-4" class="tab-pane" role="tabpanel">
										Step Content 4
									</div>
								</div>
							</div>
						...
						<div class="col-12 col-xxl-6">
							<div id="smartwizard-arrows-primary" class="wizard wizard-primary mb-4">
								<ul class="nav">
									<li class="nav-item"><a class="nav-link" href="#arrows-primary-step-1">Step Title<br /><small>Step description</small></a>
									</li>
									<li class="nav-item"><a class="nav-link" href="#arrows-primary-step-2">Step Title<br /><small>Step description</small></a>
									</li>
									<li class="nav-item"><a class="nav-link" href="#arrows-primary-step-3">Step Title<br /><small>Step description</small></a>
									</li>
									<li class="nav-item"><a class="nav-link" href="#arrows-primary-step-4">Step Title<br /><small>Step description</small></a>
									</li>
								</ul>
								...
								<div class="tab-content">
									...
									<div id="arrows-primary-step-4" class="tab-pane" role="tabpanel">
										Step Content 4
									</div>
								</div>
							</div>
							<div id="smartwizard-arrows-success" class="wizard wizard-success mb-4">
								<ul class="nav">
									<li class="nav-item"><a class="nav-link" href="#arrows-success-step-1">Step Title<br /><small>Step description</small></a>
									</li>
									<li class="nav-item"><a class="nav-link" href="#arrows-success-step-2">Step Title<br /><small>Step description</small></a>
									</li>
									<li class="nav-item"><a class="nav-link" href="#arrows-success-step-3">Step Title<br /><small>Step description</small></a>
									</li>
									<li class="nav-item"><a class="nav-link" href="#arrows-success-step-4">Step Title<br /><small>Step description</small></a>
									</li>
								</ul>
							...
							<div id="smartwizard-arrows-danger" class="wizard wizard-danger mb-4">
								<ul class="nav">
									<li class="nav-item"><a class="nav-link" href="#arrows-danger-step-1">Step Title<br /><small>Step description</small></a>
									</li>
									<li class="nav-item"><a class="nav-link" href="#arrows-danger-step-2">Step Title<br /><small>Step description</small></a>
									</li>
									<li class="nav-item"><a class="nav-link" href="#arrows-danger-step-3">Step Title<br /><small>Step description</small></a>
									</li>
									<li class="nav-item"><a class="nav-link" href="#arrows-danger-step-4">Step Title<br /><small>Step description</small></a>
									</li>
								</ul>

								<div class="tab-content">
									<div id="arrows-danger-step-1" class="tab-pane" role="tabpanel">
										Step Content 1
									</div>
									<div id="arrows-danger-step-2" class="tab-pane" role="tabpanel">
										Step Content 2
									</div>
									<div id="arrows-danger-step-3" class="tab-pane" role="tabpanel">
										Step Content 3
									</div>
									<div id="arrows-danger-step-4" class="tab-pane" role="tabpanel">
										Step Content 4
									</div>
								</div>
							</div>
						...
						<div class="col-12">
							<form id="smartwizard-validation" class="wizard wizard-primary" action="javascript:void(0)">
								<ul class="nav">
									<li class="nav-item"><a class="nav-link" href="#validation-step-1">First Step<br /><small>Step description</small></a></li>
									<li class="nav-item"><a class="nav-link" href="#validation-step-2">Second Step<br /><small>Step description</small></a></li>
