...
<form method="POST" action="/NotaMinta/{{$NotaMinta->id}}">
    ...
    <br> Pelulus <input type="text" class="form-control" name="ro_pelulus" value="{{$NotaMinta->ro_pelulus}}">
    <br> Catatan Pelulus <input type="text" lass="form-control" name="ro_pelulus_catatan" value="{{$NotaMinta->ro_pelulus_catatan}}">
    <br> Tarikh Permintaan Diluluskan <input type="date" class="form-control" name="ro_pelulus_date" value="{{$NotaMinta->ro_pelulus_date}}">
    <br> Status Permintaan <input type="text" lass="form-control" name="ro_status" value="{{$NotaMinta->ro_status}}">
